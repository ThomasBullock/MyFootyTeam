...
const Loader = () => {
    return (
        ...
        <div className="loader">
            <svg width="200px"  height="200px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="lds-ellipsis" style={{"background" : "none"}}>
                <circle cx="84" cy="50" r="0" fill="#ffc40e">
                ...
                <circle cx="84" cy="50" r="6.74865" fill="#e82c75">
                ...
                <circle cx="61.0546" cy="50" r="10" fill="#a026bf">
                ...
                <circle cx="27.0546" cy="50" r="10" fill="#48ded4">
                ...
                <circle cx="16" cy="50" r="3.25135" fill="#ffc40e">
