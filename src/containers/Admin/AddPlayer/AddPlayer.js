        ...
        return (
            <div className="addplayer">
                ...
                <form onSubmit={this.handleSubmit}>
                    <TextField required className="form__input" name="name" hintText="Name" value={this.state.name} onChange={this.handleChange} />
                    <TextField required className="form__input" name="surname" hintText="Surname" value={this.state.surname} onChange={this.handleChange} />
                    <TextField required className="form__input" name="number" hintText="Number" value={this.state.number} onChange={this.handleChange} />
                    <SelectField
                        name="primary"
                    ...
                    <TextField className="form__input" name="height" hintText="Height" value={this.state.height} onChange={this.handleChange} />
                    <SelectField
                    ...
                    <TextField className="form__input" name="goals" hintText="Goals" value={this.state.goals} onChange={this.handleChange} />
                    <DatePicker name="dob" hintText="Landscape Dialog" mode="landscape" defaultDate={defaultDate} onChange={this.handleDateChange} />
